...
class RobotState:
    """
    Encapsulates the complete current state of the Kinova Gen3 robot.
    Acts as the single source of truth for hardware telemetry.
    """
    ...
    # --- Cartesian Space (Tool Center Point - TCP) ---
    ...
    # --- Wrench (Forces and Torques at TCP) ---
